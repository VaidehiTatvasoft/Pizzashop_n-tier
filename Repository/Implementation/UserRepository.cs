...
public class UserRepository : IUserRepository
{
    ...
    public IEnumerable<User> GetUserList( int id, string searchString, string sortOrder, int pageIndex, int pageSize, out int count)
    {
        ...
        {
            userQuery = userQuery.Where(u => (u.FirstName + " " + u.LastName).ToLower().Contains(searchString.ToLower()) || u.FirstName.ToLower().Contains(searchString.ToLower()) || u.LastName.ToLower().Contains(searchString.ToLower()));
